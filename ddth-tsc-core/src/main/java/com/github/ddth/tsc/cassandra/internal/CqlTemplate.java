...
public class CqlTemplate {
    ...
    public final static String COL_METADATA_COUNTER = "c";
    public final static String COL_METADATA_METADATA = "o";
    public final static String CQL_TEMPLATE_GET_METADATA = "SELECT c,o FROM {0} WHERE c=?";
