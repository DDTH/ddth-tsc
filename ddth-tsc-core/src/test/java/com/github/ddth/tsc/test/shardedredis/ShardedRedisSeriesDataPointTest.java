 ...
 * @since 0.7.0
 */
public class ShardedRedisSeriesDataPointTest extends BaseSeriesDataPointTest {
    /**
     ...
     */
    public ShardedRedisSeriesDataPointTest(String testName) {
        super(testName);
    }
    ...
    public static Test suite() {
        return new TestSuite(ShardedRedisSeriesDataPointTest.class);
    }
