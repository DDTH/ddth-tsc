 ...
 * @since 0.7.0
 */
public class ShardedRedisSingleDataPointTest extends BaseSingleDataPointTest {
    /**
     ...
     */
    public ShardedRedisSingleDataPointTest(String testName) {
        super(testName);
    }
    ...
    public static Test suite() {
        return new TestSuite(ShardedRedisSingleDataPointTest.class);
    }
