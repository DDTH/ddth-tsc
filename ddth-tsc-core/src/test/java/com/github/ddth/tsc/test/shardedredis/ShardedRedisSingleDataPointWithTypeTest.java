 ...
 * @since 0.7.0
 */
public class ShardedRedisSingleDataPointWithTypeTest extends BaseSingleDataPointWithTypeTest {
    /**
     ...
     */
    public ShardedRedisSingleDataPointWithTypeTest(String testName) {
        super(testName);
    }
    ...
    public static Test suite() {
        return new TestSuite(ShardedRedisSingleDataPointWithTypeTest.class);
    }
