 ...
 * @since 0.1.0
 */
public class RedisSingleDataPointTest extends BaseSingleDataPointTest {
    /**
     ...
     */
    public RedisSingleDataPointTest(String testName) {
        super(testName);
    }
    ...
    public static Test suite() {
        return new TestSuite(RedisSingleDataPointTest.class);
    }
