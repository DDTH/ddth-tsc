 ...
 * @since 0.3.0
 */
public class RedisSingleDataPointWithTypeTest extends BaseSingleDataPointWithTypeTest {
    /**
     ...
     */
    public RedisSingleDataPointWithTypeTest(String testName) {
        super(testName);
    }
    ...
    public static Test suite() {
        return new TestSuite(RedisSingleDataPointWithTypeTest.class);
    }
