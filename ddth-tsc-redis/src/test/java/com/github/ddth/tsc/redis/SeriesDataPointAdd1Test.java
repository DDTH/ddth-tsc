 ...
 * @since 0.4.0
 */
public class SeriesDataPointAdd1Test extends BaseCounterTest {
    /**
     ...
     */
    public SeriesDataPointAdd1Test(String testName) {
        super(testName);
    }
    ...
    public static Test suite() {
        return new TestSuite(SeriesDataPointAdd1Test.class);
    }
    ...
    public void testSeriesDataPoints1() throws InterruptedException {
        ...
        DataPoint[] dataPoints = counter1.getSeries(timestampStart, timestampEnd);
